"""
Django settings for vetlink_project project.
...
SECRET_KEY = 'django-insecure-7-a$_dad4r1*6#9^hxw^)m6v##7o+p85hp!jk(5$ez#3djk2)9'
...
WSGI_APPLICATION = 'vetlink_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'vetlink_db',           # nombre de tu base de datos
